    ...
    <div style={{ backgroundColor: "#F5EFE3", fontFamily: "'Inter', sans-serif" }}>
      <section className="flex flex-col lg:flex-row" style={{ minHeight: "100svh" }}>
        ...
        <div className="relative flex-1 overflow-hidden min-h-[50svh] landscape:min-h-[100svh] lg:min-h-0">
          ...
          {/* Logo */}
          <div className="absolute top-4 left-4 sm:top-7 sm:left-7 z-10 bg-black/50 backdrop-blur-md rounded-2xl p-2">
            <img src="https://media.base44.com/images/public/69e68470b4eb59a82dcf3e9c/02c4d00b2_Screenshot2026-05-08at53712PM.png" className="h-8 sm:h-10 object-contain" />
          </div>
      ...
      <section style={{ backgroundColor: "#F5EFE3" }} className="px-6 py-16 max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          {/* Single responsive grid — single column on mobile, 2 col on sm, 3 col on lg */}
