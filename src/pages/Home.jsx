    ...
    <div style={{ backgroundColor: "#F5EFE3", fontFamily: "'Inter', sans-serif" }}>
      <section className="flex flex-col lg:flex-row" style={{ minHeight: "100svh" }}>
        ...
        <div className="relative flex-1 overflow-hidden min-h-[50svh] landscape:min-h-[100svh] lg:min-h-0">
          ...
          {/* Logo */}
          <div className="absolute top-4 left-4 sm:top-7 sm:left-7 flex items-center gap-2 z-10 bg-black/50 backdrop-blur-md rounded-2xl px-3 py-2">
            <div className="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center flex-shrink-0 bg-white rounded-lg">
