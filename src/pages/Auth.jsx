      ...
      case STEPS.LANGUAGE:
        return (
          <>
            ...
            <p className="text-white/50 text-sm mb-6">The financial home for Filipinos abroad.</p>
      ...
      case STEPS.SIGNUP_NAME:
        return (
          <>
            ...
            <p className="text-white/50 text-sm mb-6">Free remittance. Real banking. Built for the way you support family.</p>
            ...
            <button onClick={() => name.trim() && setStep(STEPS.SIGNUP_EMAIL)} disabled={!name.trim()}
              className="w-full bg-primary text-white font-bold py-3.5 rounded-xl hover:bg-primary/90 transition-colors disabled:opacity-40">
              Continue
            </button>
          </>
        );
        ...
        return (
          <>
            ...
            <button onClick={handleSignUp} disabled={password.length < 8 || loading}
              className="w-full bg-primary text-white font-bold py-3.5 rounded-xl hover:bg-primary/90 transition-colors disabled:opacity-60 flex items-center justify-center gap-2">
        ...
        return (
          <>
            ...
            <button onClick={handleVerifyOtp} disabled={otpCode.length < 4 || loading}
              className="w-full bg-primary text-white font-bold py-3.5 rounded-xl hover:bg-primary/90 transition-colors disabled:opacity-60 mb-3 flex items-center justify-center gap-2">
              {loading && <Loader2 className="w-4 h-4 animate-spin" />}
      ...
      case STEPS.SIGNIN:
        return (
          <>
            ...
            <p className="text-white/50 text-sm mb-6">Welcome back to KinnectFi.</p>
            ...
            <button onClick={handleSignIn} disabled={loading}
              className="w-full bg-white text-[#0D1F3C] font-bold py-3.5 rounded-xl hover:bg-white/90 transition-colors disabled:opacity-60 flex items-center justify-center gap-2">
              {loading && <Loader2 className="w-4 h-4 animate-spin" />}
      ...
      <div className="hidden sm:flex relative flex-1 flex-col justify-end p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          <Link to="/" className="flex items-center gap-2 mb-8">
            <div className="w-9 h-9 rounded-xl overflow-hidden bg-white flex items-center justify-center flex-shrink-0"><img src="https://media.base44.com/images/public/69e68470b4eb59a82dcf3e9c/815953c27_svg_008.svg" className="w-full h-full object-contain p-0.5" /></div>
            <div><div className="font-extrabold text-white text-lg leading-none" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>kinnect<span className="text-primary">fi</span></div><div className="text-white/40 text-[9px] tracking-widest uppercase">Financial home for Filipinos</div></div>
          </Link>
          <h1 className="text-5xl font-extrabold text-white leading-tight mb-4" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            The financial<br />home for<br /><span className="text-primary">Filipinos abroad.</span>
          </h1>
          <p className="text-white/70 text-lg mb-8">Free remittance. Real banking.<br />Built for the way you support family.</p>
      ...
      <div className="w-full sm:w-[400px] xl:w-[440px] flex-shrink-0 bg-[#0f1a2e] flex flex-col justify-center px-8 sm:px-16 py-10 relative overflow-y-auto">
        ...
        <div className="max-w-sm w-full">
          ...
          {tab === "signup" && step !== STEPS.LANGUAGE && (
            <>
              ...
              <p className="text-white/40 text-xs text-center mb-4">or continue with email</p>
            </>
          )}
        ...
        <div className="mt-8 flex flex-col gap-2">
          <div className="flex items-center justify-center gap-2 bg-white/5 rounded-full py-2 px-4 w-fit mx-auto">
            ...
            <span className="text-white/50 text-[10px] uppercase tracking-widest">Bank-Grade Secure</span>
          </div>
