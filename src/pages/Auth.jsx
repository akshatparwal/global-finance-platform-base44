      ...
      case STEPS.LANGUAGE:
        return (
          <>
            ...
            <p className="text-white/50 text-sm mb-6">Join the Kayah family</p>
      ...
      case STEPS.SIGNIN:
        return (
          <>
            ...
            <p className="text-white/50 text-sm mb-6">Sign in to your Kayah account.</p>
      ...
      <div className="hidden sm:flex relative flex-1 flex-col justify-end p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          <Link to="/" className="flex items-center gap-2 mb-8">
            ...
            <div><div className="font-extrabold text-white text-lg leading-none" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Ka<span className="text-primary">yah</span></div><div className="text-white/40 text-[9px] tracking-widest uppercase">Cross-Border Bank</div></div>
          </Link>
          <h1 className="text-5xl font-extrabold text-white leading-tight mb-4" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            Your money,<br /><span className="text-primary">connected</span><br />to your heart.
          </h1>
